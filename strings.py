TEXTS = {
    ...
    'uz': {
        ...
        'menu_text': '🏠 Menu',
        'viloyat_select': '🗺 **Qaysi viloyatga borasiz?**\n\nViloyatni tanlang:',
        'error_not_text': '⚠️ Iltimos, mashina raqamini yozing (Rasm emas).',
        'error_file_large': '⚠️ Fayl juda katta (10MB dan ko\'p). Kichikroq rasm yuklang.',
        'phone_changed': '✅ Raqam o\'zgartirildi!',
        'lang_changed': '✅ Til o\'zgartirildi!',
        'request_sent': '✅ So\'rovingiz yuborildi! Javobni kutib turing.',
        'btn_agree': '✅ Roziman',
        'btn_share_phone': '📱 Raqamni yuborish',
        'btn_unknown_post': 'ANIQ EMAS',
        'error_general': '❌ Xatolik yuz berdi. Qaytadan urinib ko\'ring.',
        'main_menu_text': '🏠 Asosiy menyu:\n\nQuyidagi tugmalardan birini tanlang:',
        'referral_new_friend': '🎉 **Yangi do\'st!**\n\n👤 {name} sizning havolangiz orqali botga qo\'shildi!\n💰 +2,000 tanga qo\'shildi!\n\n🎁 Do\'stingiz birinchi xizmatdan foydalansa, yana +17,500 tanga olasiz!',
        'referral_reward': '🎁 **MUKOFOT!**\n\nDo\'stingiz xizmatdan foydalandi!\n💰 +17,500 tanga qo\'shildi!',
        'app_accepted_user': '✅ **Arizangiz qabul qilindi!**\n\n🆔 Kod: `{code}`\n⏳ Admin narxni belgilayapti...',
        'app_rejected_user': '❌ **Arizangiz rad etildi**\n\n🆔 Kod: `{code}`\n\n📞 Qo\'shimcha ma\'lumot uchun admin bilan bog\'laning:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **DEKLARATSIYA TAYYOR:**',
        'declaration_ready_code': '📋 **DEKLARATSIYA TAYYOR!**\n\n🆔 Kod: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Admin javob:**',
        'sent_to_user': '✅ Foydalanuvchiga yuborildi!',
        'send_failed': '❌ Yuborib bo\'lmadi',
        'payment_success_title': '✅ **TO\'LOV MUVAFFAQIYATLI!**\n\n🆔 Ariza: `{code}`\n💰 To\'landi: **{amount}**\n\nTez orada hujjatlaringizni olasiz!',
        'not_enough_coins_msg': 'Yetarli tangalar yo\'q!\n\nSizda: {balance} tanga\nKerak: 35,000 tanga',
        'coins_payment_confirm': '💰 **Tangalar bilan to\'lash**\n\n🆔 Ariza: `{code}`\n💎 Olinadi: **35,000 tanga**\n💰 Qoladi: **{remaining} tanga**\n\nTasdiqlaysizmi?',
        'payment_cancelled': 'Bekor qilindi.',
        'no_pending_app': 'Hozirda to\'lov kutayotgan ariza yo\'q.\nAvval ariza yuboring va admin narx belgilasin.',
        'press_start': 'Iltimos, avval /start bosing.',
        'btn_confirm': 'Tasdiqlash',
        'payme_title': '💳 **PAYME ORQALI TO\'LOV**\n\n🆔 Ariza: `{code}`\n💰 Summa: **{amount} UZS**\n\nQuyidagi tugmani bosib to\'lovni amalga oshiring.\nTo\'lov muvaffaqiyatli bo\'lgandan so\'ng, arizangiz avtomatik tasdiqlanadi.',
        'click_title': '💳 **CLICK ORQALI TO\'LOV**\n\n🆔 Ariza: `{code}`\n💰 Summa: **{amount} UZS**\n\nQuyidagi tugmani bosib to\'lovni amalga oshiring.',
        'payment_page_ready': 'To\'lov sahifasi tayyor!',
        'btn_pay_coins': '🪙 Tangalardan to\'lash',
        'app_confirmed_pay': '✅ **Arizangiz tasdiqlandi!**\n\n🆔 Ariza: `{code}`\n💰 To\'lov summasi: **{amount} UZS**\n\n📌 To\'lov usulini tanlang:',
    },
    ...
    'oz': {
        ...
        'menu_text': '🏠 Меню',
        'viloyat_select': '🗺 **Қайси вилоятга борасиз?**\n\nВилоятни танланг:',
        'error_not_text': '⚠️ Илтимос, машина рақамини ёзинг (Расм эмас).',
        'error_file_large': '⚠️ Файл жуда катта (10МБ дан кўп). Кичикроқ расм юкланг.',
        'phone_changed': '✅ Рақам ўзгартирилди!',
        'lang_changed': '✅ Тил ўзгартирилди!',
        'request_sent': '✅ Сўровингиз юборилди! Жавобни кутиб туринг.',
        'btn_agree': '✅ Розиман',
        'btn_share_phone': '📱 Рақамни юбориш',
        'btn_unknown_post': 'АНИҚ ЭМАС',
        'error_general': '❌ Хатолик юз берди. Қайтадан уриниб кўринг.',
        'main_menu_text': '🏠 Асосий меню:\n\nҚуйидаги тугмалардан бирини танланг:',
        'referral_new_friend': '🎉 **Янги дўст!**\n\n👤 {name} сизнинг ҳаволангиз орқали ботга қўшилди!\n💰 +2,000 танга қўшилди!\n\n🎁 Дўстингиз биринчи хизматдан фойдалансa, яна +17,500 танга оласиз!',
        'referral_reward': '🎁 **МУКОФОТ!**\n\nДўстингиз хизматдан фойдаланди!\n💰 +17,500 танга қўшилди!',
        'app_accepted_user': '✅ **Аризангиз қабул қилинди!**\n\n🆔 Код: `{code}`\n⏳ Админ нархни белгилаяпти...',
        'app_rejected_user': '❌ **Аризангиз рад этилди**\n\n🆔 Код: `{code}`\n\n📞 Қўшимча маълумот учун админ билан боғланинг:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **ДЕКЛАРАЦИЯ ТАЙЁР:**',
        'declaration_ready_code': '📋 **ДЕКЛАРАЦИЯ ТАЙЁР!**\n\n🆔 Код: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Админ жавоб:**',
        'sent_to_user': '✅ Фойдаланувчига юборилди!',
        'send_failed': '❌ Юбориб бўлмади',
        'payment_success_title': '✅ **ТЎЛОВ МУВАФФАҚИЯТЛИ!**\n\n🆔 Ариза: `{code}`\n💰 Тўланди: **{amount}**\n\nТез орада ҳужжатларингизни оласиз!',
        'not_enough_coins_msg': 'Етарли тангалар йўқ!\n\nСизда: {balance} танга\nКерак: 35,000 танга',
        'coins_payment_confirm': '💰 **Тангалар билан тўлаш**\n\n🆔 Ариза: `{code}`\n💎 Олинади: **35,000 танга**\n💰 Қолади: **{remaining} танга**\n\nТасдиқлайсизми?',
        'payment_cancelled': 'Бекор қилинди.',
        'no_pending_app': 'Ҳозирда тўлов кутаётган ариза йўқ.\nАввал ариза юборинг ва админ нарх белгиласин.',
        'press_start': 'Илтимос, аввал /start босинг.',
        'btn_confirm': 'Тасдиқлаш',
        'payme_title': '💳 **PAYME ОРҚАЛИ ТЎЛОВ**\n\n🆔 Ариза: `{code}`\n💰 Сумма: **{amount} UZS**\n\nҚуйидаги тугмани босиб тўловни амалга оширинг.',
        'click_title': '💳 **CLICK ОРҚАЛИ ТЎЛОВ**\n\n🆔 Ариза: `{code}`\n💰 Сумма: **{amount} UZS**\n\nҚуйидаги тугмани босиб тўловни амалга оширинг.',
        'payment_page_ready': 'Тўлов саҳифаси тайёр!',
        'btn_pay_coins': '🪙 Тангалардан тўлаш',
        'app_confirmed_pay': '✅ **Аризангиз тасдиқланди!**\n\n🆔 Ариза: `{code}`\n💰 Тўлов суммаси: **{amount} UZS**\n\n📌 Тўлов усулини танланг:',
    },
    ...
    'ru': {
        ...
        'menu_text': '🏠 Меню',
        'viloyat_select': '🗺 **В какой регион вы едете?**\n\nВыберите регион:',
        'error_not_text': '⚠️ Пожалуйста, введите номер машины (не фото).',
        'error_file_large': '⚠️ Файл слишком большой (более 10МБ). Загрузите файл поменьше.',
        'phone_changed': '✅ Номер изменён!',
        'lang_changed': '✅ Язык изменён!',
        'request_sent': '✅ Ваш запрос отправлен! Ожидайте ответа.',
        'btn_agree': '✅ Согласен',
        'btn_share_phone': '📱 Отправить номер',
        'btn_unknown_post': 'НЕ ЗНАЮ',
        'error_general': '❌ Произошла ошибка. Попробуйте снова.',
        'main_menu_text': '🏠 Главное меню:\n\nВыберите одну из кнопок ниже:',
        'referral_new_friend': '🎉 **Новый друг!**\n\n👤 {name} присоединился через вашу ссылку!\n💰 +2,000 монет добавлено!\n\n🎁 Когда друг воспользуется услугой, вы получите ещё +17,500 монет!',
        'referral_reward': '🎁 **НАГРАДА!**\n\nВаш друг воспользовался услугой!\n💰 +17,500 монет добавлено!',
        'app_accepted_user': '✅ **Ваша заявка принята!**\n\n🆔 Код: `{code}`\n⏳ Админ устанавливает цену...',
        'app_rejected_user': '❌ **Ваша заявка отклонена**\n\n🆔 Код: `{code}`\n\n📞 Для доп. информации свяжитесь с админом:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **ДЕКЛАРАЦИЯ ГОТОВА:**',
        'declaration_ready_code': '📋 **ДЕКЛАРАЦИЯ ГОТОВА!**\n\n🆔 Код: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Ответ админа:**',
        'sent_to_user': '✅ Отправлено пользователю!',
        'send_failed': '❌ Не удалось отправить',
        'payment_success_title': '✅ **ОПЛАТА УСПЕШНА!**\n\n🆔 Заявка: `{code}`\n💰 Оплачено: **{amount}**\n\nСкоро вы получите ваши документы!',
        'not_enough_coins_msg': 'Недостаточно монет!\n\nУ вас: {balance} монет\nНужно: 35,000 монет',
        'coins_payment_confirm': '💰 **Оплата монетами**\n\n🆔 Заявка: `{code}`\n💎 Будет списано: **35,000 монет**\n💰 Останется: **{remaining} монет**\n\nПодтверждаете?',
        'payment_cancelled': 'Отменено.',
        'no_pending_app': 'Нет заявок, ожидающих оплаты.\nСначала подайте заявку и дождитесь установки цены.',
        'press_start': 'Пожалуйста, сначала нажмите /start.',
        'btn_confirm': 'Подтвердить',
        'payme_title': '💳 **ОПЛАТА ЧЕРЕЗ PAYME**\n\n🆔 Заявка: `{code}`\n💰 Сумма: **{amount} UZS**\n\nНажмите кнопку ниже для оплаты.',
        'click_title': '💳 **ОПЛАТА ЧЕРЕЗ CLICK**\n\n🆔 Заявка: `{code}`\n💰 Сумма: **{amount} UZS**\n\nНажмите кнопку ниже для оплаты.',
        'payment_page_ready': 'Страница оплаты готова!',
        'btn_pay_coins': '🪙 Оплатить монетами',
        'app_confirmed_pay': '✅ **Ваша заявка подтверждена!**\n\n🆔 Заявка: `{code}`\n💰 Сумма к оплате: **{amount} UZS**\n\n📌 Выберите способ оплаты:',
    },
    ...
    'en': {
        ...
        'menu_text': '🏠 Menu',
        'viloyat_select': '🗺 **Which region are you going to?**\n\nSelect a region:',
        'error_not_text': '⚠️ Please enter the vehicle number (not a photo).',
        'error_file_large': '⚠️ File too large (over 10MB). Please upload a smaller image.',
        'phone_changed': '✅ Phone number changed!',
        'lang_changed': '✅ Language changed!',
        'request_sent': '✅ Your request has been sent! Please wait for a response.',
        'btn_agree': '✅ I Agree',
        'btn_share_phone': '📱 Share Contact',
        'btn_unknown_post': 'NOT SURE',
        'error_general': '❌ An error occurred. Please try again.',
        'main_menu_text': '🏠 Main menu:\n\nSelect one of the buttons below:',
        'referral_new_friend': '🎉 **New friend!**\n\n👤 {name} joined via your referral link!\n💰 +2,000 coins added!\n\n🎁 When your friend uses a service, you\'ll get +17,500 more coins!',
        'referral_reward': '🎁 **REWARD!**\n\nYour friend used the service!\n💰 +17,500 coins added!',
        'app_accepted_user': '✅ **Your application has been accepted!**\n\n🆔 Code: `{code}`\n⏳ Admin is setting the price...',
        'app_rejected_user': '❌ **Your application has been rejected**\n\n🆔 Code: `{code}`\n\n📞 For more information, contact admin:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **DECLARATION READY:**',
        'declaration_ready_code': '📋 **DECLARATION READY!**\n\n🆔 Code: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Admin reply:**',
        'sent_to_user': '✅ Sent to user!',
        'send_failed': '❌ Failed to send',
        'payment_success_title': '✅ **PAYMENT SUCCESSFUL!**\n\n🆔 Application: `{code}`\n💰 Paid: **{amount}**\n\nYou will receive your documents soon!',
        'not_enough_coins_msg': 'Not enough coins!\n\nYou have: {balance} coins\nNeeded: 35,000 coins',
        'coins_payment_confirm': '💰 **Pay with coins**\n\n🆔 Application: `{code}`\n💎 Will be taken: **35,000 coins**\n💰 Remaining: **{remaining} coins**\n\nDo you confirm?',
        'payment_cancelled': 'Cancelled.',
        'no_pending_app': 'No applications awaiting payment.\nSubmit an application first and wait for pricing.',
        'press_start': 'Please press /start first.',
        'btn_confirm': 'Confirm',
        'payme_title': '💳 **PAYMENT VIA PAYME**\n\n🆔 Application: `{code}`\n💰 Amount: **{amount} UZS**\n\nPress the button below to make payment.',
        'click_title': '💳 **PAYMENT VIA CLICK**\n\n🆔 Application: `{code}`\n💰 Amount: **{amount} UZS**\n\nPress the button below to make payment.',
        'payment_page_ready': 'Payment page ready!',
        'btn_pay_coins': '🪙 Pay with coins',
        'app_confirmed_pay': '✅ **Your application is confirmed!**\n\n🆔 Application: `{code}`\n💰 Payment amount: **{amount} UZS**\n\n📌 Select a payment method:',
    },
    ...
    'kz': {
        ...
        'menu_text': '🏠 Мәзір',
        'viloyat_select': '🗺 **Қай аймаққа барасыз?**\n\nАймақты таңдаңыз:',
        'error_not_text': '⚠️ Көлік нөмірін жазыңыз (сурет емес).',
        'error_file_large': '⚠️ Файл тым үлкен (10МБ-дан көп). Кішірек сурет жүктеңіз.',
        'phone_changed': '✅ Нөмір өзгертілді!',
        'lang_changed': '✅ Тіл өзгертілді!',
        'request_sent': '✅ Сұранысыңыз жіберілді! Жауапты күтіңіз.',
        'btn_agree': '✅ Келісемін',
        'btn_share_phone': '📱 Нөмірді жіберу',
        'btn_unknown_post': 'БЕЛГІСІЗ',
        'error_general': '❌ Қате пайда болды. Қайта көріңіз.',
        'main_menu_text': '🏠 Басты мәзір:\n\nТөмендегі түймелердің бірін таңдаңыз:',
        'referral_new_friend': '🎉 **Жаңа дос!**\n\n👤 {name} сіздің сілтемеңіз арқылы қосылды!\n💰 +2,000 тиын қосылды!\n\n🎁 Досыңыз қызметті пайдаланса, тағы +17,500 тиын аласыз!',
        'referral_reward': '🎁 **СЫЙЛЫҚ!**\n\nДосыңыз қызметті пайдаланды!\n💰 +17,500 тиын қосылды!',
        'app_accepted_user': '✅ **Өтінішіңіз қабылданды!**\n\n🆔 Код: `{code}`\n⏳ Админ бағаны белгілеп жатыр...',
        'app_rejected_user': '❌ **Өтінішіңіз қабылданбады**\n\n🆔 Код: `{code}`\n\n📞 Қосымша ақпарат үшін админге хабарласыңыз:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **ДЕКЛАРАЦИЯ ДАЙЫН:**',
        'declaration_ready_code': '📋 **ДЕКЛАРАЦИЯ ДАЙЫН!**\n\n🆔 Код: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Админ жауабы:**',
        'sent_to_user': '✅ Пайдаланушыға жіберілді!',
        'send_failed': '❌ Жіберу мүмкін болмады',
        'payment_success_title': '✅ **ТӨЛЕМ СӘТТІ!**\n\n🆔 Өтініш: `{code}`\n💰 Төленді: **{amount}**\n\nЖақын арада құжаттарыңызды аласыз!',
        'not_enough_coins_msg': 'Тиындар жеткіліксіз!\n\nСізде: {balance} тиын\nКерек: 35,000 тиын',
        'coins_payment_confirm': '💰 **Тиындармен төлеу**\n\n🆔 Өтініш: `{code}`\n💎 Алынады: **35,000 тиын**\n💰 Қалады: **{remaining} тиын**\n\nРастайсыз ба?',
        'payment_cancelled': 'Бас тартылды.',
        'no_pending_app': 'Қазір төлемді күтіп тұрған өтініш жоқ.\nАлдымен өтініш беріңіз.',
        'press_start': 'Алдымен /start басыңыз.',
        'btn_confirm': 'Растау',
        'payme_title': '💳 **PAYME АРҚЫЛЫ ТӨЛЕМ**\n\n🆔 Өтініш: `{code}`\n💰 Сома: **{amount} UZS**\n\nТөлемді жасау үшін төмендегі түймені басыңыз.',
        'click_title': '💳 **CLICK АРҚЫЛЫ ТӨЛЕМ**\n\n🆔 Өтініш: `{code}`\n💰 Сома: **{amount} UZS**\n\nТөлемді жасау үшін төмендегі түймені басыңыз.',
        'payment_page_ready': 'Төлем беті дайын!',
        'btn_pay_coins': '🪙 Тиындармен төлеу',
        'app_confirmed_pay': '✅ **Өтінішіңіз расталды!**\n\n🆔 Өтініш: `{code}`\n💰 Төлем сомасы: **{amount} UZS**\n\n📌 Төлем әдісін таңдаңыз:',
    },
    ...
    'kg': {
        ...
        'menu_text': '🏠 Меню',
        'viloyat_select': '🗺 **Кайсы аймакка барасыз?**\n\nАймакты тандаңыз:',
        'error_not_text': '⚠️ Унаа номерин жазыңыз (сүрөт эмес).',
        'error_file_large': '⚠️ Файл өтө чоң (10МБ ашуун). Кичине сүрөт жүктөңүз.',
        'phone_changed': '✅ Номер өзгөртүлдү!',
        'lang_changed': '✅ Тил өзгөртүлдү!',
        'request_sent': '✅ Суроо-талабыңыз жөнөтүлдү! Жоопту күтүңүз.',
        'btn_agree': '✅ Макулмун',
        'btn_share_phone': '📱 Номерди жөнөтүү',
        'btn_unknown_post': 'БЕЛГИСИЗ',
        'error_general': '❌ Ката кетти. Кайра аракет кылыңыз.',
        'main_menu_text': '🏠 Башкы меню:\n\nТөмөндөгү баскычтардын бирин тандаңыз:',
        'referral_new_friend': '🎉 **Жаңы дос!**\n\n👤 {name} сиздин шилтемеңиз аркылуу кошулду!\n💰 +2,000 тыйын кошулду!\n\n🎁 Досуңуз кызматты колдонсо, дагы +17,500 тыйын аласыз!',
        'referral_reward': '🎁 **СЫЙЛЫК!**\n\nДосуңуз кызматты колдонду!\n💰 +17,500 тыйын кошулду!',
        'app_accepted_user': '✅ **Арызыңыз кабыл алынды!**\n\n🆔 Код: `{code}`\n⏳ Админ баа коюп жатат...',
        'app_rejected_user': '❌ **Арызыңыз четке кагылды**\n\n🆔 Код: `{code}`\n\n📞 Кошумча маалымат үчүн админге кайрылыңыз:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **ДЕКЛАРАЦИЯ ДАЯР:**',
        'declaration_ready_code': '📋 **ДЕКЛАРАЦИЯ ДАЯР!**\n\n🆔 Код: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Админ жообу:**',
        'sent_to_user': '✅ Колдонуучуга жөнөтүлдү!',
        'send_failed': '❌ Жөнөтүү мүмкүн болбоду',
        'payment_success_title': '✅ **ТӨЛӨМ ИЙГИЛИКТҮҮ!**\n\n🆔 Арыз: `{code}`\n💰 Төлөндү: **{amount}**\n\nЖакында документтериңизди аласыз!',
        'not_enough_coins_msg': 'Тыйындар жетишсиз!\n\nСизде: {balance} тыйын\nКерек: 35,000 тыйын',
        'coins_payment_confirm': '💰 **Тыйындар менен төлөө**\n\n🆔 Арыз: `{code}`\n💎 Алынат: **35,000 тыйын**\n💰 Калат: **{remaining} тыйын**\n\nТастыктайсызбы?',
        'payment_cancelled': 'Жокко чыгарылды.',
        'no_pending_app': 'Азырынча төлөмдү күтүп жаткан арыз жок.\nАлгач арыз бериңиз.',
        'press_start': 'Алгач /start басыңыз.',
        'btn_confirm': 'Тастыктоо',
        'payme_title': '💳 **PAYME АРКЫЛУУ ТӨЛӨМ**\n\n🆔 Арыз: `{code}`\n💰 Сумма: **{amount} UZS**\n\nТөлөм жасоо үчүн төмөндөгү баскычты басыңыз.',
        'click_title': '💳 **CLICK АРКЫЛУУ ТӨЛӨМ**\n\n🆔 Арыз: `{code}`\n💰 Сумма: **{amount} UZS**\n\nТөлөм жасоо үчүн төмөндөгү баскычты басыңыз.',
        'payment_page_ready': 'Төлөм бети даяр!',
        'btn_pay_coins': '🪙 Тыйындар менен төлөө',
        'app_confirmed_pay': '✅ **Арызыңыз тастыкталды!**\n\n🆔 Арыз: `{code}`\n💰 Төлөм суммасы: **{amount} UZS**\n\n📌 Төлөм ыкмасын тандаңыз:',
    },
    ...
    'tj': {
        ...
        'menu_text': '🏠 Меню',
        'viloyat_select': '🗺 **Ба кадом вилоят меравед?**\n\nВилоятро интихоб кунед:',
        'error_not_text': '⚠️ Лутфан, рақами мошинро нависед (на сурат).',
        'error_file_large': '⚠️ Файл хеле калон аст (аз 10МБ зиёд). Сурати хурдтар бор кунед.',
        'phone_changed': '✅ Рақам иваз шуд!',
        'lang_changed': '✅ Забон иваз шуд!',
        'request_sent': '✅ Дархости шумо фиристода шуд! Ҷавобро интизор шавед.',
        'btn_agree': '✅ Розиям',
        'btn_share_phone': '📱 Рақамро фиристодан',
        'btn_unknown_post': 'МАЪЛУМ НЕСТ',
        'error_general': '❌ Хатогӣ рух дод. Дубора кӯшиш кунед.',
        'main_menu_text': '🏠 Менюи асосӣ:\n\nЯке аз тугмаҳоро интихоб кунед:',
        'referral_new_friend': '🎉 **Дӯсти нав!**\n\n👤 {name} тавассути линки шумо ба бот ҳамроҳ шуд!\n💰 +2,000 танга илова шуд!\n\n🎁 Агар дӯстатон аз хизмат истифода барад, боз +17,500 танга мегиред!',
        'referral_reward': '🎁 **МУКОФОТ!**\n\nДӯсти шумо аз хизмат истифода бурд!\n💰 +17,500 танга илова шуд!',
        'app_accepted_user': '✅ **Аризаи шумо қабул шуд!**\n\n🆔 Код: `{code}`\n⏳ Админ нархро муқаррар мекунад...',
        'app_rejected_user': '❌ **Аризаи шумо рад шуд**\n\n🆔 Код: `{code}`\n\n📞 Барои маълумоти бештар бо админ тамос гиред:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **ДЕКЛАРАТСИЯ ТАЙЁР:**',
        'declaration_ready_code': '📋 **ДЕКЛАРАТСИЯ ТАЙЁР!**\n\n🆔 Код: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Ҷавоби админ:**',
        'sent_to_user': '✅ Ба истифодабаранда фиристода шуд!',
        'send_failed': '❌ Фиристодан имкон надошт',
        'payment_success_title': '✅ **ПАРДОХТ МУВАФФАҚ!**\n\n🆔 Ариза: `{code}`\n💰 Пардохт шуд: **{amount}**\n\nТез ҳуҷҷатҳоятонро мегиред!',
        'not_enough_coins_msg': 'Тангаҳо кифоя нест!\n\nДар шумо: {balance} танга\nЛозим: 35,000 танга',
        'coins_payment_confirm': '💰 **Бо тангаҳо пардохт**\n\n🆔 Ариза: `{code}`\n💎 Гирифта мешавад: **35,000 танга**\n💰 Боқӣ мемонад: **{remaining} танга**\n\nТасдиқ мекунед?',
        'payment_cancelled': 'Бекор карда шуд.',
        'no_pending_app': 'Ҳоло аризае ки пардохтро интизор аст, нест.\nАввал ариза диҳед.',
        'press_start': 'Лутфан, аввал /start -ро пахш кунед.',
        'btn_confirm': 'Тасдиқ',
        'payme_title': '💳 **ПАРДОХТ ТАВАССУТИ PAYME**\n\n🆔 Ариза: `{code}`\n💰 Маблағ: **{amount} UZS**\n\nБарои пардохт тугмаи зеринро пахш кунед.',
        'click_title': '💳 **ПАРДОХТ ТАВАССУТИ CLICK**\n\n🆔 Ариза: `{code}`\n💰 Маблағ: **{amount} UZS**\n\nБарои пардохт тугмаи зеринро пахш кунед.',
        'payment_page_ready': 'Саҳифаи пардохт тайёр!',
        'btn_pay_coins': '🪙 Бо тангаҳо пардохтан',
        'app_confirmed_pay': '✅ **Аризаи шумо тасдиқ шуд!**\n\n🆔 Ариза: `{code}`\n💰 Маблағи пардохт: **{amount} UZS**\n\n📌 Усули пардохтро интихоб кунед:',
    },
    ...
    'tr': {
        ...
        'menu_text': '🏠 Menü',
        'viloyat_select': '🗺 **Hangi bölgeye gidiyorsunuz?**\n\nBölge seçin:',
        'error_not_text': '⚠️ Lütfen araç numarasını yazın (fotoğraf değil).',
        'error_file_large': '⚠️ Dosya çok büyük (10MB\'den fazla). Daha küçük bir dosya yükleyin.',
        'phone_changed': '✅ Numara değiştirildi!',
        'lang_changed': '✅ Dil değiştirildi!',
        'request_sent': '✅ Talebiniz gönderildi! Yanıt bekleyin.',
        'btn_agree': '✅ Kabul Ediyorum',
        'btn_share_phone': '📱 Numarayı Gönder',
        'btn_unknown_post': 'BİLMİYORUM',
        'error_general': '❌ Bir hata oluştu. Tekrar deneyin.',
        'main_menu_text': '🏠 Ana menü:\n\nAşağıdaki düğmelerden birini seçin:',
        'referral_new_friend': '🎉 **Yeni arkadaş!**\n\n👤 {name} bağlantınız aracılığıyla katıldı!\n💰 +2.000 jeton eklendi!\n\n🎁 Arkadaşınız hizmeti kullandığında +17.500 jeton kazanırsınız!',
        'referral_reward': '🎁 **ÖDÜL!**\n\nArkadaşınız hizmeti kullandı!\n💰 +17.500 jeton eklendi!',
        'app_accepted_user': '✅ **Başvurunuz kabul edildi!**\n\n🆔 Kod: `{code}`\n⏳ Yönetici fiyat belirliyor...',
        'app_rejected_user': '❌ **Başvurunuz reddedildi**\n\n🆔 Kod: `{code}`\n\n📞 Daha fazla bilgi için yöneticiyle iletişime geçin:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **BEYANNAME HAZIR:**',
        'declaration_ready_code': '📋 **BEYANNAME HAZIR!**\n\n🆔 Kod: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Yönetici yanıtı:**',
        'sent_to_user': '✅ Kullanıcıya gönderildi!',
        'send_failed': '❌ Gönderilemedi',
        'payment_success_title': '✅ **ÖDEME BAŞARILI!**\n\n🆔 Başvuru: `{code}`\n💰 Ödendi: **{amount}**\n\nYakında belgelerinizi alacaksınız!',
        'not_enough_coins_msg': 'Yetersiz jeton!\n\nSizde: {balance} jeton\nGerekli: 35.000 jeton',
        'coins_payment_confirm': '💰 **Jetonlarla ödeme**\n\n🆔 Başvuru: `{code}`\n💎 Alınacak: **35.000 jeton**\n💰 Kalacak: **{remaining} jeton**\n\nOnaylıyor musunuz?',
        'payment_cancelled': 'İptal edildi.',
        'no_pending_app': 'Şu anda ödeme bekleyen başvuru yok.\nÖnce başvuru gönderin.',
        'press_start': 'Lütfen önce /start tuşuna basın.',
        'btn_confirm': 'Onayla',
        'payme_title': '💳 **PAYME İLE ÖDEME**\n\n🆔 Başvuru: `{code}`\n💰 Tutar: **{amount} UZS**\n\nÖdeme yapmak için aşağıdaki düğmeye basın.',
        'click_title': '💳 **CLICK İLE ÖDEME**\n\n🆔 Başvuru: `{code}`\n💰 Tutar: **{amount} UZS**\n\nÖdeme yapmak için aşağıdaki düğmeye basın.',
        'payment_page_ready': 'Ödeme sayfası hazır!',
        'btn_pay_coins': '🪙 Jetonlarla öde',
        'app_confirmed_pay': '✅ **Başvurunuz onaylandı!**\n\n🆔 Başvuru: `{code}`\n💰 Ödeme tutarı: **{amount} UZS**\n\n📌 Ödeme yöntemini seçin:',
    },
    ...
    'tm': {
        ...
        'menu_text': '🏠 Menýu',
        'viloyat_select': '🗺 **Haýsy welaýata barýarsyňyz?**\n\nWelaýaty saýlaň:',
        'error_not_text': '⚠️ Haýyş, ulag belgisini ýazyň (surat däl).',
        'error_file_large': '⚠️ Faýl gaty uly (10MB-den köp). Kiçiräk surat ýükläň.',
        'phone_changed': '✅ Belgi üýtgedildi!',
        'lang_changed': '✅ Dil üýtgedildi!',
        'request_sent': '✅ Haýyşyňyz iberildi! Jogaby garaşyň.',
        'btn_agree': '✅ Razylaşýaryn',
        'btn_share_phone': '📱 Belgini ibermek',
        'btn_unknown_post': 'BELLI DÄL',
        'error_general': '❌ Ýalňyşlyk ýüze çykdy. Gaýtadan synanyşyň.',
        'main_menu_text': '🏠 Baş menýu:\n\nAşakdaky düwmeleriň birini saýlaň:',
        'referral_new_friend': '🎉 **Täze dost!**\n\n👤 {name} siziň baglanyşygyňyz arkaly goşuldy!\n💰 +2,000 teňňe goşuldy!\n\n🎁 Dostuňyz hyzmatdan peýdalansa, ýene +17,500 teňňe alarsyňyz!',
        'referral_reward': '🎁 **SYLAG!**\n\nDostuňyz hyzmatdan peýdalandy!\n💰 +17,500 teňňe goşuldy!',
        'app_accepted_user': '✅ **Arzaňyz kabul edildi!**\n\n🆔 Kod: `{code}`\n⏳ Admin bahany belleýär...',
        'app_rejected_user': '❌ **Arzaňyz ret edildi**\n\n🆔 Kod: `{code}`\n\n📞 Goşmaça maglumat üçin admin bilen habarlaşyň:\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **DEKLARASIÝA TAÝÝAR:**',
        'declaration_ready_code': '📋 **DEKLARASIÝA TAÝÝAR!**\n\n🆔 Kod: `{code}`',
        'admin_reply_prefix': '👮‍♂️ **Admin jogaby:**',
        'sent_to_user': '✅ Ulanyjyga iberildi!',
        'send_failed': '❌ Iberip bolmady',
        'payment_success_title': '✅ **TÖLEG ÜSTÜNLIKLI!**\n\n🆔 Arza: `{code}`\n💰 Tölendi: **{amount}**\n\nÝakyn wagtda resminamalaryňyzy alarsyňyz!',
        'not_enough_coins_msg': 'Teňňeler ýeterlik däl!\n\nSizde: {balance} teňňe\nGerek: 35,000 teňňe',
        'coins_payment_confirm': '💰 **Teňňeler bilen tölemek**\n\n🆔 Arza: `{code}`\n💎 Alynýar: **35,000 teňňe**\n💰 Galýar: **{remaining} teňňe**\n\nTassyklaýarsyňyzmy?',
        'payment_cancelled': 'Ýatyryldy.',
        'no_pending_app': 'Häzirki wagtda tölege garaşýan arza ýok.\nIlki bilen arza iberiň.',
        'press_start': 'Haýyş, ilki /start basyň.',
        'btn_confirm': 'Tassyklamak',
        'payme_title': '💳 **PAYME ARKALY TÖLEG**\n\n🆔 Arza: `{code}`\n💰 Möçber: **{amount} UZS**\n\nTöleg etmek üçin aşakdaky düwmä basyň.',
        'click_title': '💳 **CLICK ARKALY TÖLEG**\n\n🆔 Arza: `{code}`\n💰 Möçber: **{amount} UZS**\n\nTöleg etmek üçin aşakdaky düwmä basyň.',
        'payment_page_ready': 'Töleg sahypasy taýýar!',
        'btn_pay_coins': '🪙 Teňňeler bilen tölemek',
        'app_confirmed_pay': '✅ **Arzaňyz tassyklandy!**\n\n🆔 Arza: `{code}`\n💰 Töleg möçberi: **{amount} UZS**\n\n📌 Töleg usulyny saýlaň:',
    },
    ...
    'zh': {
        ...
        'btn_my_coins': '我的金币',
        'menu_text': '🏠 菜单',
        'viloyat_select': '🗺 **您要去哪个地区？**\n\n请选择地区：',
        'error_not_text': '⚠️ 请输入车牌号（不是照片）。',
        'error_file_large': '⚠️ 文件太大（超过10MB）。请上传较小的图片。',
        'phone_changed': '✅ 号码已更改！',
        'lang_changed': '✅ 语言已更改！',
        'request_sent': '✅ 您的请求已发送！请等待回复。',
        'btn_agree': '✅ 我同意',
        'btn_share_phone': '📱 发送号码',
        'btn_unknown_post': '不确定',
        'error_general': '❌ 发生错误。请重试。',
        'main_menu_text': '🏠 主菜单：\n\n请选择以下按钮之一：',
        'referral_new_friend': '🎉 **新朋友！**\n\n👤 {name} 通过您的链接加入了！\n💰 +2,000 硬币已添加！\n\n🎁 当您的朋友使用服务时，您将获得 +17,500 硬币！',
        'referral_reward': '🎁 **奖励！**\n\n您的朋友使用了服务！\n💰 +17,500 硬币已添加！',
        'app_accepted_user': '✅ **您的申请已被接受！**\n\n🆔 代码：`{code}`\n⏳ 管理员正在设定价格...',
        'app_rejected_user': '❌ **您的申请已被拒绝**\n\n🆔 代码：`{code}`\n\n📞 如需更多信息，请联系管理员：\n• +998 91 702 00 99\n• @CARAVAN_TRANZIT',
        'declaration_ready': '📋 **报关单已准备好：**',
        'declaration_ready_code': '📋 **报关单已准备好！**\n\n🆔 代码：`{code}`',
        'admin_reply_prefix': '👮‍♂️ **管理员回复：**',
        'sent_to_user': '✅ 已发送给用户！',
        'send_failed': '❌ 发送失败',
        'payment_success_title': '✅ **支付成功！**\n\n🆔 申请：`{code}`\n💰 已支付：**{amount}**\n\n您将很快收到您的文件！',
        'not_enough_coins_msg': '硬币不足！\n\n您有：{balance} 硬币\n需要：35,000 硬币',
        'coins_payment_confirm': '💰 **用硬币支付**\n\n🆔 申请：`{code}`\n💎 将扣除：**35,000 硬币**\n💰 剩余：**{remaining} 硬币**\n\n确认吗？',
        'payment_cancelled': '已取消。',
        'no_pending_app': '目前没有等待付款的申请。\n请先提交申请。',
        'press_start': '请先按 /start。',
        'btn_confirm': '确认',
        'payme_title': '💳 **通过PAYME支付**\n\n🆔 申请：`{code}`\n💰 金额：**{amount} UZS**\n\n点击下方按钮进行支付。',
        'click_title': '💳 **通过CLICK支付**\n\n🆔 申请：`{code}`\n💰 金额：**{amount} UZS**\n\n点击下方按钮进行支付。',
        'payment_page_ready': '支付页面已准备好！',
        'btn_pay_coins': '🪙 用硬币支付',
        'app_confirmed_pay': '✅ **您的申请已确认！**\n\n🆔 申请：`{code}`\n💰 支付金额：**{amount} UZS**\n\n📌 请选择支付方式：',
    }
}
